...
\end{wrapfigure}
Sofia `e una ragazza inizialmente timida e introversa, ma quando trova una persona con cui si sente in confidenza non impiega molto tempo ad aprirsi. Le piacciono molto le ma- terie scientifiche, in particolare fisica, e questo l’ha spinta un anno fa a iscriversi al liceo scientifico. Lei stessa si definisce una nerd, infatti ama i libri fantasy e ha letto diverse volte la saga di Harry Potter. Inoltre, il sabato sera si incontra regolarmente con gli amici per partecipare a giochi di ruolo, come ad esempio Dungeons and Dragons. In una di queste serate ha anche conosciuto Giorgio, il suo attuale fidanzato.
\subsubsection{Arianna, 14 anni}
\begin{wrapfigure}{l}{0.3\textwidth}
  \centering
  \includegraphics[width=0.3\textwidth]{"Images Latex/Personas/Arianna"}
\end{wrapfigure}
In questo tipo di grafico, più la zona colorata è estesa, più vi è una mancanza o lacuna verso quella competenza. Visto da questo punto di vista è abbastanza intuitivo per individuare in quali competenze e abilità il soggetto eccelle (soglia dell'area colorata più verso il centro) e in quale scarseggia (soglia dell'area colorata più verso l'esterno). per individuare in quali competenze e abilità il soggetto eccelle (soglia dell'area colorata più verso il centro) e in quale scarseggia (soglia dell'area colorata più verso l'esterno). per individuare in quali competenze e abilità il soggetto eccelle (soglia dell'area colorata più verso il centro) e in quale scarseggia (soglia dell'area colorata più verso l'esterno).
